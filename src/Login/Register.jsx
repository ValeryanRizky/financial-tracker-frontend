                ...
                <div className="flex flex-col items-center">
                    ...
                    {success && (
                        <motion.div
                            ...
                            className="w-full mt-4 p-3 bg-green-50 border border-green-200 rounded-xl flex items-center gap-2 text-green-600"
                        >
                            <CheckCircle size={18} />
                    ...
                    {/* Register Form */}
                    <form onSubmit={handleRegister} className="w-full space-y-5 mt-6">
                        ...
                        <motion.button
                            ...
                            className={`w-full bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white font-bold py-4 rounded-2xl shadow-[0_10px_20px_rgba(79,70,229,0.3)] flex items-center justify-center gap-2 group transition-all 
